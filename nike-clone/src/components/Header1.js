  ...
  const handleMouseOut = (event) => {
    ...
    const Jordan = () => {
        return (
            ...
            height='24px' width='24px' fill='#111' viewBox="0 0 26 32">
    ...
    const Converse = () => {
        return (
            ...
            onMouseOver={handleMouseOver}
            onMouseOut={handleMouseOut} 
            height='24px' width='24px' fill='#111' viewBox="0 0 39 33">
    ...
    <div
        id='Header1'>
            ...
            <div id='header1menu'>
                <p class='menuoption'>Find a Store <div class='spacer'>|</div></p>
                <p class='menuoption'>  Help <div class='spacer'>|</div></p>
                <p class='menuoption'>  Join Us <div class='spacer'>|</div></p>
                <p class='menuoption'>  Sign In</p>
            </div>
